! function($) {
    $.fn.extend({
        ...
        options: null,
        load: function(e, s) {
            this.element = e, this.timeout = null, this.options = s, "" == $(e).val() && $(e).val(s.text), $(e).attr("autocomplete", "off"), 0 == $("#sf_sb").length && $("body").append('<div id="sf_sb" class="sf_sb" style="position:absolute;display:none;width:' + s.width + 'px;z-index:9999"><div class="sf_sb_cont"><div class="sf_sb_top"></div><div id="sf_results" style="width:100%"><div id="sf_val" ></div><div id="sf_more"></div></div><div class="sf_sb_bottom"></div></div></div>'), $.ajaxyLiveSearch.loadEvents(this)
        },
