<?php
$bdaia_related          = bdayh_get_option( 'bdaia_related' );
$bdaia_related_author   = bdayh_get_option( 'bdaia_related_author' );
$bdaia_related_cat      = bdayh_get_option( 'bdaia_related_cat' );
			...
			<ul>
				<?php if( $bdaia_related ){ ?>
					<li id="nav-more-ralated">
						<a href="#content-more-ralated"><?php _e( 'Related Articles', LANG ); ?></a>
					</li>
				<?php } ?>
