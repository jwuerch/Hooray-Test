...
function home2_scrolling_box( $k,$arr ) {

    global $wp_cats; ?>

    <div class="builder_inner" id="home2_box_<?php echo $k; ?>">
        <input type="hidden" name="home2[<?php echo $k; ?>][type]" value="scrolling_box_home2" />
        <div class="boxes_title" title="Scrolling Box"><i class="handle fa fa-navicon"></i>
            <?php echo $arr['title']; ?>
