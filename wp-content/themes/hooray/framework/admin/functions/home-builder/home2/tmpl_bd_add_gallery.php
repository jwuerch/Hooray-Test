<script id="bd_add_gallery_home2" type="text/x-tmpl">
    <div>
        <div class="builder_inner" id="home2_box_{{= data}}">
            <input type="hidden" name="home2[{{= data}}][type]" value="gallery_box_home2" />
            ...
            <div class="builder_content">
                <div class="bd_item_content of">
                    ...
                    <div class="bd_option_item">
                        ...
                        <input type="text" name="home2[{{= data}}][title]" value="News In Gallery">
                    </div>
