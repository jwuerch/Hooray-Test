 ...
 * home2_news_box
 */
function home2_news_box( $k,$arr ) {

    global $wp_cats; ?>

    <div class="builder_inner" id="home2_box_<?php echo $k; ?>">
        <input type="hidden" name="home2[<?php echo $k; ?>][type]" value="news_box_home2" />
                ...
                <div class="bd_option_item">
                    ...
                    <ul class="box_layout_list layouts-inner">
                        <li <?php if($arr['layout'] == 1){?>class="selectd" <?php }?>>
                            ...
                            <input name="home2[<?php echo $k; ?>][layout]" type="radio" <?php if($arr['layout'] == 1){?> checked="checked" <?php }?> value="1"  />
                        </li>
                        <li <?php if($arr['layout'] == 2){?>class="selectd" <?php }?>>
                            <span class="layout-img home-box2"><i></i></span>
                            <input name="home2[<?php echo $k; ?>][layout]" type="radio" <?php if($arr['layout'] == 2){?> checked="checked" <?php }?> value="2"  />
                        </li>
                        <li <?php if($arr['layout'] == 3){?>class="selectd" <?php }?>>
                            <span class="layout-img home-box3"><i></i></span>
                            <input name="home2[<?php echo $k; ?>][layout]" type="radio" <?php if($arr['layout'] == 3){?> checked="checked" <?php }?>  value="3"  />
                        </li>
                        <li <?php if(intval($arr['layout']) == 4){echo 'class="selectd"';}?> >
                            <span class="layout-img home-box4"><i></i></span>
                            <input name="home2[<?php echo $k; ?>][layout]" type="radio" <?php if(intval($arr['layout']) == 4){?> checked="checked" <?php }?> value="4"  />
                        </li>

                        <li <?php if(intval($arr['layout']) == 5){echo 'class="selectd"';}?> >
                            <span class="layout-img home-box5"><i></i></span>
                            <input name="home2[<?php echo $k; ?>][layout]" type="radio" <?php if(intval($arr['layout']) == 5){?> checked="checked" <?php }?> value="5"  />
                        </li>

                        <li <?php if(intval($arr['layout']) == 6){echo 'class="selectd"';}?> >
                            <span class="layout-img home-box6"><i></i></span>
                            <input name="home2[<?php echo $k; ?>][layout]" type="radio" <?php if(intval($arr['layout']) == 6){?> checked="checked" <?php }?> value="6"  />
                        </li>

                        <li <?php if(intval($arr['layout']) == 7){echo 'class="selectd"';}?> >
                            <span class="layout-img home-box7"><i></i></span>
                            <input name="home2[<?php echo $k; ?>][layout]" type="radio" <?php if(intval($arr['layout']) == 7){?> checked="checked" <?php }?> value="7"  />
                        </li>

                        <li <?php if(intval($arr['layout']) == 8){echo 'class="selectd"';}?> >
                            <span class="layout-img home-box8"><i></i></span>
                            <input name="home2[<?php echo $k; ?>][layout]" type="radio" <?php if(intval($arr['layout']) == 8){?> checked="checked" <?php }?> value="8"  />
                        </li>

                        <li <?php if(intval($arr['layout']) == 9){echo 'class="selectd"';}?> >
                            <span class="layout-img home-box9"><i></i></span>
                            <input name="home2[<?php echo $k; ?>][layout]" type="radio" <?php if(intval($arr['layout']) == 9){?> checked="checked" <?php }?> value="9"  />
                        </li>

                        <li <?php if(intval($arr['layout']) == 10){echo 'class="selectd"';}?> >
                            <span class="layout-img home-box10"><i></i></span>
                            <input name="home2[<?php echo $k; ?>][layout]" type="radio" <?php if(intval($arr['layout']) == 10){?> checked="checked" <?php }?> value="10"  />
                        </li>
                    </ul>
                </div>
            </div>
