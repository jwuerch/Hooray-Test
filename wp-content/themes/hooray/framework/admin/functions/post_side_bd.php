 ...
 *  Post Sidebars
 */
function post_side_bd( $input, $head = true )
{
    ...
    <ul class="box_layout_list bd_box_layout layouts-inner">
        ...
        <li <?php if( bdayh_get_option( $input['id'] ) == 'sideRight' ){ echo 'class="selectd"'; } ?>>
            <span class="layout-img side-right">
                <i></i>
            </span>
            <input name="<?php echo $input['id']; ?>" <?php if( bdayh_get_option( $input['id'] ) == 'sideRight' ){ echo 'checked="checked"'; } ?> type="radio" value="sideRight" />
        </li>

        <li <?php if( bdayh_get_option( $input['id'] ) == 'sideLeft' ){ echo 'class="selectd"'; } ?>>
            <span class="layout-img side-left">
                <i></i>
            </span>
            <input name="<?php echo $input['id']; ?>" <?php if( bdayh_get_option( $input['id'] ) == 'sideLeft' ){ echo 'checked="checked"'; } ?> type="radio" value="sideLeft" />
        </li>

        <li <?php if( bdayh_get_option( $input['id'] ) == 'sideNo' ){ echo 'class="selectd"'; } ?>>
            <span class="layout-img side-no">
                <i></i>
            </span>
            <input name="<?php echo $input['id']; ?>" <?php if( bdayh_get_option( $input['id'] ) == 'sideNo' ){ echo 'checked="checked"'; } ?> type="radio" value="sideNo" />
        </li>
    </ul> <?php echo '</div>'."\n";
}
?>