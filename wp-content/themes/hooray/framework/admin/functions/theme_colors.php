...
function theme_colors($input,$head = true)
{
    ...
    <ul class="box_layout_list bd_box_layout">
	    ...
	    <li <?php if($bd_option['bd_setting']['theme_colors'] == 'color0'){ echo 'class="selectd"'; } ?>>
		    <span class="theme_colors_spans color-0"></span>
		    <input name="theme_colors" <?php if($bd_option['bd_setting']['theme_colors'] == 'color0'){ echo 'checked="checked"'; } ?> type="radio" value="color0" />
	    </li>

	    <li <?php if($bd_option['bd_setting']['theme_colors'] == 'color01'){ echo 'class="selectd"'; } ?>>
		    <span class="theme_colors_spans color-01"></span>
		    <input name="theme_colors" <?php if($bd_option['bd_setting']['theme_colors'] == 'color01'){ echo 'checked="checked"'; } ?> type="radio" value="color01" />
	    </li>
