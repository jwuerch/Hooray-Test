...
<?php if($bd_review_enable == 1) { ?>
    <div id="bd-review-wrapper" class="bd-review-placement-<?php echo($bd_criteria_display); ?>">
                ...
                <h3>
                    ...
                    if($bd_review_type == 'percent')
                    {
	                    ...
	                    <span style="display: none;" itemprop="reviewRating" itemscope="" itemtype="http://schema.org/Rating">
                                    ...
                                    <meta itemprop="ratingValue" content = "<?php echo $bd_final_percentage; ?>" />
                                </span>
	                    <?php
                    }
                    else
                    {
	                    ...
	                    <span style="display: none;" itemprop="reviewRating" itemscope="" itemtype="http://schema.org/Rating">
                                    ...
                                    <meta itemprop="ratingValue" content = "<?php echo $bd_final_score; ?>" />
                                </span>
	                    <?php
                    }
                    ?>
        ...
        {
            ?>
            <div class="bd-user-review-criteria">
                <span class="bd-user-review-description">
                <b><span class="your_rating" style="display:none;"><?php _e('Your Rating', LANG); ?></span>
                    <span class="user_rating"><?php _e('User Rating', LANG); ?></span></b>: <span class="score"><?php echo $ratings->current_rating; ?></span> <small>(<span class="count"><?php echo $ratings->count; ?></span> <?php _e('votes', LANG); ?>)</small></span>
