...
function getPostLikeLink($post_id){
    ...
    if(hasAlreadyVoted($post_id))
        $output .= ' <span title="'.__('I like this article', LANG).'" class="qtip like alreadyvoted"><i class="fa fa-heart"></i></span>';
    else
        $output .= '<a href="#" data-post_id="'.$post_id.'">
					<span  title="'.__('I like this article', LANG).'"class="qtip like"><i class="fa fa-heart"></i></span>
				</a>';
    if($vote_count)
