...
?>
    ...
    <div class="folio-container bd-blog-masonry loading">
        <div id="folio-main">
                        ...
                        while($gallery->have_posts()): $gallery->the_post();
                            ...
                            <div class="folio-item portfolio-item isotope-item post-item <?php echo $item_classes; ?>" data-categories="<?php echo $item_classes; ?>">
                                ...
                                <div class="inner-desc">
                                    <h3 class="tite"><a href="<?php echo $permalink; ?>"><?php the_title(); ?></a> <span class="cate"><?php echo get_the_term_list( get_the_ID(), 'portfolio_category', '', ', ', '' ); ?></span></h3>
                                </div><!-- .inner-desc -->
                            </div><!-- .folio-item -->
            ...
            <div class="clear"></div>
            <div class="bd-container"><?php bd_wpagination( $gallery->max_num_pages, $range = 2 ); wp_reset_postdata(); ?></div>
        </div><!-- #folio-main -->
