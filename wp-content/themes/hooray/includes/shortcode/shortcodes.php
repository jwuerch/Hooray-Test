...
if ( ! function_exists( 'youtube' ) ) {
    function youtube($atts, $content = null){
        ...
        $out = "<div class='bd-video-shortcode'><iframe width='660' height='471.25' src='http://www.youtube.com/embed/" . $youtubeurl . "?rel=0' frameborder='0' allowfullscreen></iframe></div>";
        return $out;
    }
}
...
if ( ! function_exists( 'vimeo' ) ) {
    function vimeo($atts, $content = null){
        ...
        $out = '<div class="bd-video-shortcode">

<script src="//f.vimeocdn.com/js/froogaloop2.min.js"></script>
            <iframe id="player1" src="//player.vimeo.com/video/'.$vimeourl.'?api=1&player_id=player1" width="660" height="471.25" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
        ';
        return $out;
    }
}
