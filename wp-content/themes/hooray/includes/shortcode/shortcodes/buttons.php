...
<html lang="en">
<head>
<title><?php _e('Insert Button',LANG); ?></title>
...
<form name="button" action="#" >
	<div class="panel_wrapper">
		<fieldset style="margin-bottom:10px;padding:10px">
			<legend><?php _e('Type of button:',LANG); ?></legend>
			<label for="button_type"><?php _e('Choose a type:',LANG); ?></label><br><br>
			<select data-name="type" id="button_type" style="width:250px">
				<option value="" disabled selected><?php _e('Select type',LANG); ?></option>
				<option value="bd_button btn_small"><?php _e('small button',LANG); ?></option>
				<option value="bd_button btn_middle"><?php _e('middle button black',LANG); ?></option>
				<option value="bd_button btn_large"><?php _e('large color button',LANG); ?></option>
			</select>
		</fieldset>
		<fieldset style="margin-bottom:10px;padding:10px">
			<legend><?php _e('URL for button:',LANG); ?></legend>
			<label><?php _e('Type your URL here:',LANG); ?></label><br><br>
			<input data-name="url" type="text" id="button_url" style="width:250px">
		</fieldset>
		<fieldset style="margin-bottom:10px;padding:10px">
			<legend><?php _e('Link target:',LANG); ?></legend>
			<label><?php _e('Check if you want open in new window:',LANG); ?></label><br><br>
		...
		<fieldset style="margin-bottom:10px;padding:10px">
			<legend><?php _e('Preview:',LANG); ?></legend>
