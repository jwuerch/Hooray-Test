...
<html lang="en">
<head>
<title><?php _e('Insert Social Link',LANG); ?></title>
...
<form name="social_link" action="#" >
	<div class="panel_wrapper">
		...
		<legend><?php _e('URL for button:',LANG); ?></legend>
			<label for="button_url"><?php _e('Type your URL here:',LANG); ?></label><br><br>
			<input data-name="url" type="text" style="width:250px">
		</fieldset>
		<fieldset style="margin-bottom:10px;padding:10px">
		<legend><?php _e('Link target:',LANG); ?></legend>
			<label for="button_target"><?php _e('Check if you want open in new window:',LANG); ?></label><br><br>
