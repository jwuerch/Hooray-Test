...
class tabs_widget extends WP_Widget {
    ...
    function tabs_widget() {
        ...
        parent::__construct('bd-tabs-widget', '.: Bdaia - Tabs', $widget_ops, $control_ops);
    }
        ...
        <div class="widget widget_tabs" id="<?php echo $args['widget_id']; ?>">
            <div class="widget_container">
                ...
                <div class="tabs_content">
                    ...
                    <div class="tab_container" id="tab1-<?php echo $args['widget_id']; ?>">
                        <?php
                        if( $popular_posts_by == 'comments' ){
                            bdayh_widget_posts_list( $p_number, $args['widget_id'], '', 'popular', '' );
                        }
                        elseif( $popular_posts_by == 'views' ) {
                            bdayh_widget_posts_list( $p_number, $args['widget_id'], '', 'views', '' );
                        }
                        ?>
                    </div>

                    <div class="tab_container" id="tab2-<?php echo $args['widget_id']; ?>">
                        <?php bdayh_widget_posts_list( $l_number, $args['widget_id'], '', '', '' ); ?>
                    </div>

                    <div class="tab_container" id="tab3-<?php echo $args['widget_id']; ?>">
