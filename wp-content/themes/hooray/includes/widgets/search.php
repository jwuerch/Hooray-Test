...
function bd_search_widget() {
    $widget_ops = array('classname' => 'bd-search-widget', 'description' => 'Widget search by category');
    $control_ops = array('id_base' => 'bd-search-widget');
    parent::__construct('bd-search-widget', '.: Bdaia - Search', $widget_ops, $control_ops);
}
