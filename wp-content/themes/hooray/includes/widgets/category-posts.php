...
function bd_cate_posts() {
    $widget_ops = array( 'classname' => 'bd-cate-posts', 'description' => 'Widget display Posts by category/s' );
    $control_ops = array('id_base' => 'bd-cate-posts');
    parent::__construct('bd-cate-posts', '.: Bdaia - Posts List By Category', $widget_ops, $control_ops);
}
function widget( $args, $instance ) {
    ...
    bdayh_widget_posts_list( $number, $args['widget_id'], '', 'cat',$cats_id  );
    echo $after_widget;
}
