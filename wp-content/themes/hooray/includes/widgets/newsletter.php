...
function feedburner_widget() {
    $widget_ops = array('classname' => 'bd-feedburner', 'description' => 'Widget display NewsLetter Subscribe form it feedburner');
    $control_ops = array('id_base' => 'bd-feedburner');
    parent::__construct('bd-feedburner', '.: Bdaia - Feedburner', $widget_ops, $control_ops);
}
