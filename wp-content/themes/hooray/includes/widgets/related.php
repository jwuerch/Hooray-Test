...
function bd_related() {
    $widget_ops = array('classname' => 'bd-related', 'description' => 'Widget display related posts with images in single post');
    $control_ops = array('id_base' => 'bd-related');
    parent::__construct('bd-related', '.: Bdaia - Related Posts', $widget_ops, $control_ops);
}
