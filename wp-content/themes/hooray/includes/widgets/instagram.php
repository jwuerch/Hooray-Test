...
class bd_instagram extends WP_Widget {
    function bd_instagram() {
        $widget_ops = array('classname' => 'bd-instagram', 'description' => 'Widget display Instagram Photo');
        $control_ops = array('id_base' => 'bd-instagram');
        parent::__construct('bd-instagram', '.: Bdaia - Instagram', $widget_ops, $control_ops);
    }
                                    ...
                                    <?php
                                        if ( isset( $instance['show_likes'] ) ){
                                            if( !empty( $post->likes->count ) ){
                                                echo '<div class="instagram_likes"><i class="icon-heart"></i> <span class="likes_count">'.$post->likes->count.'</span></div>';
                                            }
                                        }
                                    ?>
                                </figure>
