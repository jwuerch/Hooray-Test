...
class Ad_120_600_Widget extends WP_Widget {
    ...
    function Ad_120_600_Widget(){
        $widget_ops     = array( 'classname' => 'ad_120_600', 'description' => 'Widget ad box 120 x 600' );
        $control_ops    = array( 'width' => 250, 'height' => 350, 'id_base' => 'ad_120_600-widget' );
        parent::__construct( 'ad_120_600-widget', '.: Bdaia -  AD Box' , $widget_ops, $control_ops );
    }
