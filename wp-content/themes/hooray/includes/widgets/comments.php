...
function bd_comments_widget() {
    $widget_ops = array('classname' => 'bd-comments-widget', 'description' => 'Widget display Recent Comments with avatar');
    $control_ops = array('id_base' => 'bd-comments-widget');
    parent::__construct('bd-comments-widget', '.: Bdaia - Comments', $widget_ops, $control_ops);
}
