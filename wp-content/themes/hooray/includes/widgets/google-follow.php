...
class mts_googleplus_Widget extends WP_Widget {
    ...
    {
        $widget_ops = array('classname' => 'mts_googleplus', 'description' => 'Adds a beautiful Google Plus badge widget');
        $control_ops = array('id_base' => 'google-badge-box');
        parent::__construct('google-badge-box', '.: Bdaia - Google Plus Badge Box', $widget_ops, $control_ops);
    }
