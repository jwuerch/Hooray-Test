...
class Flickr_Widget extends WP_Widget
{
    function Flickr_Widget(){
        ...
        parent::__construct('flickr-widget', '.: Bdaia - Flickr', $widget_ops, $control_ops);
    }
            ...
            <script type="text/javascript">
                function jsonFlickrApi(rsp) {
                    ...
                    for (var i=0; i < rsp.photos.photo.length; i++) {
                        ...
                        s +=  '<div class="post-thumb"><a class="ttip" title="'+ photo.title + '" href="' + p_url + '">' + '<img width="55" height="" alt="'+ photo.title + '"src="' + t_url + '"/>' + '</a></div>';
                    }
                    document.write(s);
                }
            </script>
